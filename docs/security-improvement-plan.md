...
**Решение**:
- [ ] Удалить значение по умолчанию для `JWT_SECRET`
- [ ] Добавить валидацию силы секрета (минимум 32 символа)
- [ ] Добавить проверку на production окружение
- [ ] Обновить документацию с требованиями к секрету
...
**Решение**:
- [ ] Вынести CORS конфигурацию в ENV переменные
- [ ] Добавить валидацию доменов
- [ ] Удалить подозрительный домен
- [ ] Добавить поддержку wildcard для development
...
**Решение**:
- [ ] Добавить требование специальных символов
- [ ] Интегрировать проверку на распространенные пароли
- [ ] Добавить проверку на последовательности (123456, qwerty)
- [ ] Добавить проверку на повторяющиеся символы
...
- [ ] Не различать "пользователь не найден" и "неверный пароль"
- [ ] Добавить задержку для неудачных попыток входа
- [ ] Логировать детали только на сервере
